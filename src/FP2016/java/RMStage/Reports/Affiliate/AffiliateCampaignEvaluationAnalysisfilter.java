...
public class AffiliateCampaignEvaluationAnalysisfilter {
    ...
    public void AffiliateCampaignEvaluationAnalysis() throws Exception {
        driver.get("http://stage-registration.23traders.com/reports/affiliate_campaign_evaluation_analysis/");
        ...
        driver.findElement(By.xpath("//*[@id=\"left-side\"]/form/table/tbody/tr[2]/td[1]/div/ul/li[2]/a/label")).click();
